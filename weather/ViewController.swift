...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
                    ...
                    if let e = error {
                        ...
                        if (response as? HTTPURLResponse) != nil {
                            ...
                            if let imageData = data {
                                ...
                                // we have to update the view in the main thread
        ...
        // setup allsky image view
        self.allskyImage.clipsToBounds = true
        
    }
    
    override func viewDidLayoutSubviews() {
        self.allskyImage.layer.cornerRadius = self.allskyImage.frame.width / 2
    }
